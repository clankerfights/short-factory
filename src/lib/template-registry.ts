...
import {
  ...
  DEFAULT_TEMPLATE1_NAME,
  DEFAULT_TEMPLATE1_VERSION,
  applyDefaultTemplate1,
  isCurrentDefaultTemplate1,
} from "./default-template1";
...
const BUILT_IN_TEMPLATES: BuiltInTemplate[] = [
  {
    id: DEFAULT_TEMPLATE1_ID,
    name: DEFAULT_TEMPLATE1_NAME,
    description:
      "White hook intro, generated TTS, clustered highlight freezes, bot faces, and a clankerfights.ai outro.",
    version: DEFAULT_TEMPLATE1_VERSION,
    tags: ["automatic", "tts", "highlight-freezes"],
    apply: applyDefaultTemplate1,
    isCurrent: isCurrentDefaultTemplate1,
  },
];

export const DEFAULT_AUTOMATIC_TEMPLATE_ID = DEFAULT_TEMPLATE1_ID;
