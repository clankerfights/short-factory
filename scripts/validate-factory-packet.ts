...
validateDefaultTemplateFromFactoryPacket()
  .then(() => {
...
async function validateDefaultTemplateFromFactoryPacket(): Promise<void> {
  ...
  try {
    ...
    const composition = await applyDefaultTemplate(job, variant);
